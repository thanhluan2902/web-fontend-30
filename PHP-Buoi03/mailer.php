<?php
    function send_email($email_recive,$name,$contents,$subject){
        ...
        $mail->Username   = "anhluan29022000@gmail.com"; // Tên đăng nhập tài khoản Gmail
        $mail->Password   = "anhluan123"; //Mật khẩu của gmail
        $mail->SetFrom("anhluan29022000@gmail.com", "Zent Group"); // Thông tin người gửi
        $mail->AddReplyTo("anhluan29022000@gmail.com","Zent Group");// Ấn định email sẽ nhận khi người dùng reply lại.
    ...
    $email_recive = 'sinhnguyen0076@gmail.com';
    $name = 'Sinh';
    $contents = "helloworld";
    $subject = "Việt Nam";
